$(document).ready(function () {
    $("#edit-user-details-form").submit(function (e) {
        ...
        ajaxFormSerializeSubmit("/api/security/user/edit-user-details", "POST", form, function (err, data) {
    ...
    $("#edit-user-details-form input[name='identityAttachment']").change(function () {
        ...
        ajaxDataRequest("/api/security/user/upload-identity-attachment", "POST", data, null, function (err, data) {
            // console.log(err, data);
            if (err) {
                // Handle error
    ...
    $("#edit-user-details-form input[name='proofOfResidencyAttachment']").change(function () {
        ...
        ajaxDataRequest("/api/security/user/upload-proof-of-residency-attachment", "POST", data, null, function (err, data) {
            // console.log(err, data);
            if (err) {
                // Handle error
                if (err) alert(err.message);
    ...
    $("#edit-user-details-form input[name='nextOfKinProofOfResidencyAttachment']").change(function () {
        ...
        ajaxDataRequest("/api/security/user/upload-next-of-kin-proof-of-residency-attachment", "POST", data, null, function (err, data) {
            // console.log(err, data);
            if (err) {
                // Handle error
                if (err) alert(err.message);
    ...
    $("#edit-user-details-form input[name='nextOfKinIdentityAttachment']").change(function () {
        ...
        ajaxDataRequest("/api/security/user/upload-next-of-kin-identity-attachment", "POST", data, null, function (err, data) {
            // console.log(err, data);
            if (err) {
                // Handle error
                if (err) alert(err.message);
