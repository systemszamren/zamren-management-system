$(document).ready(function () {
    ...
    $(document).on('click', '.verifyEmailAddressBtn', function () {
        ...
        ajaxDataRequest('/api/client/user/verify-email-address', 'POST', data, btn, function (err, data) {
            if (err) {
                // Handle error
                alert(err.message);
            } else {
    ...
    $(document).on('click', '.verifyNextOfKinEmailAddressBtn', function () {
        ...
        ajaxDataRequest('/api/client/user/verify-next-of-kin-email-address', 'POST', data, btn, function (err, data) {
            if (err) {
                // Handle error
                alert(err.message);
            } else {
    ...
    $(document).on('click', '.verifyAlternativeEmailAddressBtn', function () {
        ...
        ajaxDataRequest('/api/client/user/verify-alternative-email-address', 'POST', data, btn, function (err, data) {
            if (err) {
                // Handle error
                alert(err.message);
            } else {
