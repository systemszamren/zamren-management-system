...
namespace zamren_management_system.Areas.Client.ApiControllers;
...
public class UserApiController : ControllerBase
{
    ...
    public UserApiController(UserManager<ApplicationUser> userManager,
        ...
        IEmailSender emailSender, ICypherService cypherService,
    ...
    [HasPrivilege(PrivilegeConstant.CLIENT_MANAGE_ACCOUNT)]
    public async Task<IActionResult> GetUserDetails()
    {
        try
        {
            ...
            var userDetail = await _userDetailService.FindByUserIdAsync(currentUser.Id);
            if (userDetail == null)
            ...
            var userDetailDto = new UserDetailDto
            {
                ...
                User = new UserDto
                {
                    ...
                    PhoneNumberCountryCode = _util.GetCountryCodeByPhoneNumber(currentUser.PhoneNumber),
    ...
    public async Task<IActionResult> GetUserData()
    {
        try
        {
            ...
            {
                Id = _cypherService.Encrypt(currentUser.Id),
                ...
                LockoutEnd = currentUser.LockoutEnd?.ToLocalTime(),
                LockoutEnabled = currentUser.LockoutEnabled,
                AccessFailedCount = currentUser.AccessFailedCount,
                AccountCreatedDate = currentUser.AccountCreatedDate.ToLocalTime(),
                LastSuccessfulLoginDate = currentUser.LastSuccessfulLoginDate?.ToLocalTime(),
                LastSuccessfulPasswordChangeDate = currentUser.LastSuccessfulPasswordChangeDate?.ToLocalTime(),
                AccountDeletionScheduledDate = currentUser.AccountDeletionScheduledDate?.ToLocalTime(),
                IsScheduledForDeletion = currentUser.IsScheduledForDeletion,
                IsEmployee = currentUser.IsEmployee,
                Status = currentUser.RecentActivity,
