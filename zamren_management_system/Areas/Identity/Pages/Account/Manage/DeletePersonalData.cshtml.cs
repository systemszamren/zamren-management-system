...
public class DeletePersonalDataModel : PageModel
{
    ...
    public DeletePersonalDataModel(
        ...
        ILogger<DeletePersonalDataModel> logger, IConfiguration configuration, IEmailSender emailSender,
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        //email user
        var body = _emailTemplate.DeleteAccount(
            user.FirstName,
        ...
        _logger.LogInformation("User with ID '{UserId}' requested account deletion.", userId);
